...
SELECT actor.first_name AS actor_first_name, actor.last_name AS actor_last_name, customer.first_name AS customer_first_name, customer.last_name AS customer_last_name FROM customer LEFT JOIN actor ON customer.last_name = actor.last_name;
...
SELECT actor.first_name AS actor_first_name, actor.last_name AS actor_last_name, customer.first_name AS customer_first_name, customer.last_name AS customer_last_name FROM customer RIGHT JOIN actor ON customer.last_name = actor.last_name;
...
SELECT actor.first_name AS actor_first_name, actor.last_name AS actor_last_name, customer.first_name AS customer_first_name, customer.last_name AS customer_last_name FROM customer INNER JOIN actor ON customer.last_name = actor.last_name;
